...
fetch('https://api-nba-v1.p.rapidapi.com/players?search=johnson', options)
.then(response => { 
...
Player search result will need to pull id #. 
The id # will be used to pull player stats
 
Player Card will contain the following fields: 
  First Name: [firstname]
  Last Name: [lastname]
  Birth: [birth]
  NBA Start Year: [nba.start]
  Years Pro: [nba.pro]
  Height: [height] [height.feet] [height.inches]
  weight: [weight.pounds]
  Jersey: [leagues.standard.jersey]
